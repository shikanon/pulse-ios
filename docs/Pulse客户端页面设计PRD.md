...
**目标：** 选择、预览、上传和管理图片/视频，使用户知道哪些素材会进入生成。

**入口：** C01 原创素材添加；R01 Remix 补充素材；失败页替换不可用素材。

**页面结构：**

- 系统 PhotosPicker，按产品限制选择图片和视频。
- 已选素材网格/列表：缩略图、类型、文件状态、删除、排序、用途可选标签。
- 单素材预览：图片缩放；视频播放和封面；处理失败原因。
